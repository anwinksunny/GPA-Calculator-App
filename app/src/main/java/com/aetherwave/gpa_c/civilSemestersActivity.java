...
public class civilSemestersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_civilsemesters);
        ...
        btnSemester1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(civilSemestersActivity.this, Semester1DetailsActivity.class);
        ...
        btnSemester2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(civilSemestersActivity.this, Semester2DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(civilSemestersActivity.this, civilSemester3DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(civilSemestersActivity.this, civilSemester4DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(civilSemestersActivity.this, civilSemester5DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(civilSemestersActivity.this, civilSemester6DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(civilSemestersActivity.this, civilSemester7DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(civilSemestersActivity.this, civilSemester8DetailsActivity.class);
                startActivity(intent);
            }
        });
