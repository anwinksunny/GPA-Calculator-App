...
public class mechanicalSemester8DetailsActivity extends AppCompatActivity {

    private Spinner spinnerGrade1, spinnerGrade2, spinnerGrade3, spinnerGrade4, spinnerGrade5, spinnerGrade6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mechanicalsemester8_details);
        ...
        btnCalculateSGPA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (areAllGradesSelected()) {
                    ...
                    Toast.makeText(mechanicalSemester8DetailsActivity.this, "Please select all grades.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
