...
public class csSemestersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cssemesters);
        ...
        btnSemester1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(csSemestersActivity.this, Semester1DetailsActivity.class);
        ...
        btnSemester2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(csSemestersActivity.this, Semester2DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(csSemestersActivity.this, csSemester3DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(csSemestersActivity.this, csSemester4DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(csSemestersActivity.this, csSemester5DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(csSemestersActivity.this, csSemester6DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(csSemestersActivity.this, csSemester7DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(csSemestersActivity.this, csSemester8DetailsActivity.class);
                startActivity(intent);
            }
