...
public class mechanicalSemestersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mechanicalsemesters);
        ...
        btnSemester1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mechanicalSemestersActivity.this, Semester1DetailsActivity.class);
        ...
        btnSemester2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mechanicalSemestersActivity.this, Semester2DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mechanicalSemestersActivity.this, mechanicalSemester3DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mechanicalSemestersActivity.this, mechanicalSemester4DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mechanicalSemestersActivity.this, mechanicalSemester5DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mechanicalSemestersActivity.this, mechanicalSemester6DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mechanicalSemestersActivity.this, mechanicalSemester7DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mechanicalSemestersActivity.this, mechanicalSemester8DetailsActivity.class);
                startActivity(intent);
            }
        });
