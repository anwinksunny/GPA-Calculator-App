...
public class mechanicalSemester7DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mechanicalsemester7_details);
        ...
        btnCalculateSGPA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (areAllGradesSelected()) {
                    ...
                    Toast.makeText(mechanicalSemester7DetailsActivity.this, "Please select all grades.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
