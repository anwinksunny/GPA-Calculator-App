...
public class Semester2DetailsActivity extends AppCompatActivity {

    private Spinner spinnerGrade1, spinnerGrade2, spinnerGrade3, spinnerGrade4, spinnerGrade5, spinnerGrade6, spinnerGrade7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_semester2_details);
        ...
        // Set click listener to calculate SGPA button
        btnCalculateSGPA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (areAllGradesSelected()) {
                    ...
                    Toast.makeText(Semester2DetailsActivity.this, "Please select all grades.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void calculateSGPA() {
        ...
        tvSGPAResult.setText(String.format("SGPA: %.2f", sgpa));
    }
