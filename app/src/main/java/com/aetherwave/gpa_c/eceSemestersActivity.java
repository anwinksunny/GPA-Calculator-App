...
public class eceSemestersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ecesemesters);
        ...
        btnSemester1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(eceSemestersActivity.this, Semester1DetailsActivity.class);
        ...
        btnSemester2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(eceSemestersActivity.this, Semester2DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(eceSemestersActivity.this, eceSemester3DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(eceSemestersActivity.this, eceSemester4DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(eceSemestersActivity.this, eceSemester5DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(eceSemestersActivity.this, eceSemester6DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(eceSemestersActivity.this, eceSemester7DetailsActivity.class);
                startActivity(intent);
            }
        });
        btnSemester8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(eceSemestersActivity.this, eceSemester8DetailsActivity.class);
                startActivity(intent);
            }
        });
