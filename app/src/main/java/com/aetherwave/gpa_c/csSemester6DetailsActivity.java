...
public class csSemester6DetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cssemester6_details);
        ...
        btnCalculateSGPA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (areAllGradesSelected()) {
                    ...
                    Toast.makeText(csSemester6DetailsActivity.this, "Please select all grades.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
